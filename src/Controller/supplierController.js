const { createSupplierService, getSuppliersService, getSupplierByIdService, updateSupplierByIdService } = require("../Service/supplierService");
...
exports.getSupplierById = async (req, res) => {
    try {
        ...
        if (!supplier) {
            res.status(400).json({
                status: "fail",
                error: "Couldn't find any supplier with this Id",
            });
        }
